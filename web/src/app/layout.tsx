    ...
    <html lang="pt-br">
      ...
      >
        <main className="grid min-h-screen grid-cols-2">
          <div className="relative flex flex-col items-start justify-between overflow-hidden border border-r-white/10 bg-[url(../assets/bg-stars.svg)] bg-cover px-28 py-16">
